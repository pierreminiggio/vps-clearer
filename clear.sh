...
find /var/www/html/gtts-api/public/cache/processed/ -type f -mtime +7 -name '*.mp3' -execdir rm -- '{}' ';'
find /var/www/html/gtts-api/public/cache/speechelo/ -type f -mtime +7 -name '*.mp3' -execdir rm -- '{}' ';'
